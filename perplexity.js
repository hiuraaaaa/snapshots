 ...
 * ─────────────────────────────────────────────
 *  @project    perplexity
 *  @desc       An AI that supports sources from the web, journals, etc.
 *  @author     Hiura
...
async function perplexity({ query, source = { web: true, academic: false, social: false, finance: false }} = {}) {
    try {
...
// Usage:
perplexity({ query: 'Hey! Find me the latest news in Indonesia' }).then(console.log);
